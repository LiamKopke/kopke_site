...
async function editUser(request, response) {
    try {
        ...
        await model.editUser(request.body.id, parseInt(request.body.userType) + 1, request.body.username, request.body.password, request.body.firstName, request.body.lastName, request.body.credit);
